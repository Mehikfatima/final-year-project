...
let seats = Number(localStorage.getItem("islamabadCityTourSeats")) || 18;
...
const hotels = {
  standardHotel: {
    name: "Standard Islamabad Hotel",
    adjustment: 4000,
    label: "Comfortable city stay"
  },
  premiumHotel: {
    name: "Premium Islamabad Hotel",
    adjustment: 7000,
    label: "Luxury rooms and central location"
  },
  budgetGuestHouse: {
    name: "Budget Islamabad Guest House",
    adjustment: 2000,
    label: "Low-budget city tour option"
  },
  familyRoom: {
  ...
  margallaView: {
    name: "Margalla View Stay",
    adjustment: 3500,
    label: "Scenic Islamabad stay"
  }
};
...
function updateMapAndTopLocation(city) {
  if (!city) {
    routeText.textContent = "Select your starting city to show route to Islamabad City Tour.";
    routeMap.src = "https://www.google.com/maps?q=Islamabad%20Pakistan&output=embed";
    return;
  }

  routeText.textContent = `${city} → Islamabad City Tour`;
  routeMap.src = `https://www.google.com/maps?q=${encodeURIComponent(city + " to Islamabad City Tour Pakistan")}&output=embed`;
  ...
  function updatePriceAndRoute() {
    ...
    calculatedRoute.textContent = `${city} to Islamabad City Tour`;
 ...
 function findPreviousBooking(phone) {
  ...
  return bookings
    .filter(b => b.phone === phone && b.tour === "Islamabad City Tour")
    .slice(-1)[0];
}
// function findPreviousBooking(phone) {
//   const bookings = JSON.parse(localStorage.getItem("adminBookings")) || [];
...
// }
  ...
  startLocation.addEventListener("change", function () {
    ...
    if (city === "custom") {
      customLocation.classList.remove("hide");
      priceText.textContent = "Custom price will be confirmed";
      routeText.textContent = "Enter your city to show route to Islamabad City.";
      routeMap.src = "https://www.google.com/maps?q=Islamabad%20Pakistan&output=embed";
      return;
    }
  ...
  bookingForm.addEventListener("submit", function (e) {
    ...
    formData.append("to_destination", "Islamabad");
    formData.append("route_text", city + " to Islamabad City Tour");
      ...
      .then(data => {
        if (data.success) {
          ...
          confirmationMsg.innerHTML =
            ...
            "Route: <strong>" + city + " to Islamabad City Tour</strong><br>" +
...
function getBotReply(question){
  ...
  /* ========================= */
    ...
    return `
    🕌 <strong>Islamabad City Tour</strong>
    <br><br>

    ⭐ Included Places:
    Faisal Mosque, Daman-e-Koh, Monal Viewpoint, Margalla hiking, Pakistan Monument and Rawal Lake
    <br><br>
    ...
    💸 Starting Budget:
    Rs. 6,500 per person from Islamabad
    <br><br>

    ✅ Best for families, students and corporate groups
    `;
  }
