...
let seats = Number(localStorage.getItem("shogranPublicTourSeats")) || 18;
...
const hotels = {
  standardHotel: {
    name: "Standard Shogran Hotel",
    adjustment: 3000,
    label: "Comfortable group stay"
  },
  premiumHotel: {
    name: "Premium Shogran Hotel",
    adjustment: 6000,
    label: "Better rooms and views"
  },
  budgetGuestHouse: {
    name: "Budget Guest House",
    adjustment: 1500,
    label: "Low-budget public tour option"
  },
  familyRoom: {
    name: "Family Room Sharing",
    adjustment: 4500,
    label: "Family-friendly stay"
  },
  camping: {
    name: "Camping / Bonfire Package",
    adjustment: 2500,
    label: "Adventure public tour"
  }
};
...
function updateMapAndTopLocation(city) {
  if (!city) {
    routeText.textContent = "Select your starting city to show route to Shogran.";
    routeMap.src = "https://www.google.com/maps?q=Shogran%20Pakistan&output=embed";
    return;
  }

  routeText.textContent = `${city} → Shogran`;
  routeMap.src = `https://www.google.com/maps?q=${encodeURIComponent(city + " to Shogran Pakistan")}&output=embed`;
  ...
  function updatePriceAndRoute() {
    ...
    calculatedRoute.textContent = `${city} to Shogran Public Group Tour`;
 ...
 function findPreviousBooking(phone) {
  ...
  return bookings
    .filter(b => b.phone === phone && b.tour === "Shogran Public Group Tour")
    .slice(-1)[0];
}
// function findPreviousBooking(phone) {
//   const bookings = JSON.parse(localStorage.getItem("adminBookings")) || [];
...
// }
  ...
  startLocation.addEventListener("change", function () {
    ...
    if (city === "custom") {
      customLocation.classList.remove("hide");
      priceText.textContent = "Custom price will be confirmed";
      routeText.textContent = "Enter your city to show route to Shogran.";
      routeMap.src = "https://www.google.com/maps?q=Shogran%20Pakistan&output=embed";
      return;
    }
  ...
  bookingForm.addEventListener("submit", function (e) {
    ...
    formData.append("to_destination", "Shogran");
    formData.append("route_text", city + " to Shogran Public Group Tour");
      ...
      .then(data => {
        if (data.success) {
          ...
          confirmationMsg.innerHTML =
            ...
            "Route: <strong>" + city + " to Shogran Public Group Tour</strong><br>" +
...
function getBotReply(question){
  ...
  /* ========================= */
    ...
    return `
    🌊 <strong>Shogran Public Group Tour</strong>
    <br><br>
    ...
    ⭐ Included Places:
    Deosai, Shangrila, Katpana Cold Desert, Upper Kachura Lake, Shogran Fort and Manthokha Waterfall
    <br><br>
    ...
    💸 Starting Budget:
    Rs. 14,000 per person from Shogran local, higher from other cities
    `;
  }
